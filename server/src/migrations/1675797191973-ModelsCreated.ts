...
export class ModelsCreated1675797191973 implements MigrationInterface {
    name = 'ModelsCreated1675797191973';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."communities_communitytype_enum" AS ENUM('PUBLIC', 'RESTRICTED', 'PRIVATE')`);
        await queryRunner.query(`CREATE TABLE "communities" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "title" character varying NOT NULL, "description" text, "imageUrn" character varying, "bannerUrn" character varying, "communityType" "public"."communities_communitytype_enum" NOT NULL DEFAULT 'PUBLIC', "username" character varying NOT NULL, CONSTRAINT "UQ_501bb6c8f7c8e8a7d614d9435f6" UNIQUE ("name"), CONSTRAINT "PK_fea1fe83c86ccde9d0a089e7ea2" PRIMARY KEY ("id"))`);
        ...
        // await queryRunner.query(`CREATE TYPE "public"."communities_communitytype_enum" AS ENUM('PUBLIC', 'RESTRICTED', 'PRIVATE')`);
        await queryRunner.query(`ALTER TABLE "communities" ADD "communityType" "public"."communities_communitytype_enum" NOT NULL DEFAULT 'PUBLIC'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "communities" DROP COLUMN "communityType"`);
        await queryRunner.query(`DROP TYPE "public"."communities_communitytype_enum"`);
        await queryRunner.query(`ALTER TABLE "communities" ADD "communityType" "public"."communities_communitytype_enum" NOT NULL DEFAULT 'PUBLIC'`);
